  ...
  return (
    ...
    >
      <View style={styles.slide}>
        ...
        <Image
          style={styles.image}
          source={require('../../assets/logo-apitool.png')} // Asegúrate de tener esta imagen en tu proyecto
        />
      ...
      <View style={styles.slide}>
        ...
        <Image
          style={styles.icon}
          source={require('../../assets/icons/camera.png')} // Asegúrate de tener esta imagen en tu proyecto
        />
        <Text style={styles.text}>
        ...
        <Image
          style={styles.icon}
          source={require('../../assets/icons/drum.png')} // Asegúrate de tener esta imagen en tu proyecto
        />
        <Text style={styles.text}>
        ...
        <Image
          style={styles.icon}
          source={require('../../assets/icons/paper-plane.png')} // Asegúrate de tener esta imagen en tu proyecto
        />
        <Text style={styles.text}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('screens/ListScreen')}>
          <View >
